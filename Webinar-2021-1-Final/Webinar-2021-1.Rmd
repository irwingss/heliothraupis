...
- R: Lenguaje de programación para **análisis estadístico y graficación**. ¡Es libre!.

--

- Programar es un **superpoder** que debes aprender para ser competitivo.

--

- Proceso completo de análisis de datos en un solo lugar (limpia, grafica, analiza y comunica).
...
- Gran y asombrosa **comunidad** de desarrollo.
...
# Conferencia RStudio 2020 - [Encuesta](https://github.com/rstudio/r-community-survey)  
```{r, echo=F, out.width="80%", fig.align='center'}
knitr::include_graphics("figs/like.png")
```
...
```{r, echo=F, out.width="80%", fig.align='center'}
knitr::include_graphics("figs/uses of r.png")
```
]

.panel[.panel-name[Python]
```{r, echo=F, out.width="80%", fig.align='center'}
knitr::include_graphics("figs/What Do You Use Python For.jpg")
```
]
]
...
# Conferencia RStudio 2020 - [Encuesta](https://github.com/rstudio/r-community-survey)  
```{r, echo=F, out.width="80%", fig.align='center'}
knitr::include_graphics("figs/enjoy r.png")
```
...
<br>
```{r, echo=F, out.width="80%", fig.align='center'}
knitr::include_graphics("figs/industry.png")
```

---

# Conferencia RStudio 2020 - [Encuesta](https://github.com/rstudio/r-community-survey)  <br>
<br>
<br>
```{r, echo=F, out.width="80%", fig.align='center'}
knitr::include_graphics("figs/Proficiency.png")
```
...
# Conferencia RStudio 2020 - [Encuesta](https://github.com/rstudio/r-community-survey)  
```{r, echo=F, out.width="80%", fig.align='center'}
knitr::include_graphics("figs/Problems.png")
```
...
- **Flujo de trabajo** fácil de seguir.
...
---
# Diapositivas en RStudio

- Puedes hacer diapositivas básicas incluso con RMarkdown nativo en RStudio.

- Las librerías asociadas a Xaringan permiten máxima flexibilidad y mejoran la calidad.

```{r, eval=F}
# Algunas librerías a usar en la creación de diapositivas
library(xaringan)
...
```{r, echo=F}
knitr::include_graphics("figs/bannerAUFPAS2 gracias.png")
```

# Gracias por asistir al webinar

Siguenos en: [Facebook Group](https://web.facebook.com/groups/686154108929440), [Youtube](https://www.youtube.com/channel/UCOTqfoQKMc61N_za-R6Ve7Q), [Blog](https://www.brackinstitute.com/rlatinoamerica)
